...
rng = LBDESPOT.get_rng(src, 1, 1)
r1 = rand(rng)
rng2 = LBDESPOT.get_rng(src, 1, 2)
r2 = rand(rng2)
rng = LBDESPOT.get_rng(src, 1, 1)
@test r1 == rand(rng)
r3 = rand(rng)
...
@test_logs (:warn,) LBDESPOT.check_consistency(src)
...
rng3 = LBDESPOT.get_rng(src, 1, 3)
rng4 = LBDESPOT.get_rng(src, 1, 4)
r4 = rand(rng4)
rng3 = LBDESPOT.get_rng(src, 1, 3)
r5 = rand(rng3)
r6 = rand(rng3)
